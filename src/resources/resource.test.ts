...
describe("ResourceImpl", () => {
  ...
  describe("partition", () => {
    ...
    it('should throw an error when not an ARN resource', () => {
      ...
      expect(() => resource.partition()).toThrowError("Called partition on a resource without an ARN, use isArnResource before calling partition");
    })
  })
  ...
  describe("service", () => {
    ...
    it('should throw an error when not an ARN resource', () => {
      ...
      // Then an error should be thrown
      expect(() => resource.service()).toThrowError("Called service on a resource without an ARN, use isArnResource before calling service");
    })
  })
  ...
  describe("region", () => {
    ...
    it('should throw an error when not an ARN resource', () => {
      ...
      // Then an error should be thrown
      expect(() => resource.region()).toThrowError("Called region on a resource without an ARN, use isArnResource before calling region");
    })
  })
  ...
  describe("account", () => {
    ...
    it('should throw an error when not an ARN resource', () => {
      ...
      // Then an error should be thrown
      expect(() => resource.account()).toThrowError("Called account on a resource without an ARN, use isArnResource before calling account");
    })
  })
  ...
  describe("resource", () => {
    ...
    it("should return the resource if the resource contains a colon", () => {
      // Given an ARN resource string
      const resourceString = "arn:aws:backup:us-east-1:222222222222:backup-vault:aws/efs/automatic-backup-vault";
    ...
    it('should throw an error when not an ARN resource', () => {
      ...
      // Then an error should be thrown
      expect(() => resource.resource()).toThrowError("Called resource on a resource without an ARN, use isArnResource before calling resource");
    })
  })
